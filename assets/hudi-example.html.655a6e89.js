import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o,c as p,a as n,b as s,d as e,w as u,e as i,r as c}from"./app.91dddb49.js";const l={},r=n("h1",{id:"hudi连接器使用示例",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#hudi连接器使用示例","aria-hidden":"true"},"#"),s(" Hudi连接器使用示例")],-1),d=i(`<h2 id="hudi读连接器示例" tabindex="-1"><a class="header-anchor" href="#hudi读连接器示例" aria-hidden="true">#</a> Hudi读连接器示例</h2><p>读取hudi表的用户配置:</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
